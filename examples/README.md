...
- New manager starts next month, might fix it
  ? How long do I give them
    * Two months. Write the date down now, while I'm honest.
...
* Wrong question. Not "does it work" — "for which kind of work"
...
## An SOP, with the critical parts marked

Not every use is a decision. In a procedure, `!` marks the steps where being
wrong is expensive — so the reader's eye lands on them before they start.
...
2. Book the kickoff call
   ! Never before the deposit clears
...
Ordinary numbered steps carry the procedure. The symbols carry the risk.
